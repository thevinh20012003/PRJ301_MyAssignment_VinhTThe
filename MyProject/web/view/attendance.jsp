...
<html>
    ...
    <div style="font-size: 16px; font-weight: bold; border: 1px solid #000; box-shadow: 2px 2px 5px #888; padding: 10px; margin-top: 50px; background-color: #0077b6; color: #fff;">
